...
export const layout = {
  ...
  boton:
    "py-1 px-2 flex justify-center my-1 border border-gray-400 bg-gray-400 font-poppins font-medium text-[18px] outline-none rounded-[10px] hover:bg-[#12253c] hover:text-cyan hover:border hover:border-cyan",
};
