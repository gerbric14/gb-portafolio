  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* barra */}
        <div className=" mt-4 py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-6">
        ...
        <div className="flex flex-col w-full">
          ...
          <h1 className="flex-1 font-poppins font-semibold text-[52px] ss:text-[62px] text-gradient ss:leading-[70px] leading-[75px] text-center mb-6">
